...
err1 = load_result('quick_results-8-4-4-false.txt', "HyperMinHash: 256 buckets of 4+4 bits")
err2 = load_result('quick_results-8-0-8-false.txt', "MinHash: 256 buckets of 8 bits" )
err3 = load_result('quick_results-7-0-16-false.txt', "MinHash: 128 buckets of 16 bits")
...
fig.savefig('quick_comparisons.png', dpi=300)
